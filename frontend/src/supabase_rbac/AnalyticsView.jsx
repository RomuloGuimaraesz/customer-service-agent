...
const CLICKS_ICON = `<svg viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.875 1.125L10.375 6.625L15.875 8.125L10.375 9.625L8.875 15.125L7.375 9.625L1.875 8.125L7.375 6.625L8.875 1.125Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;

const TIME_ICON = `<svg viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="8.875" cy="9.125" r="6.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M8.875 4.625V9.125L12.375 11.625" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`;

const USER_ICON = `<svg viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="8" cy="6" r="4" stroke="currentColor"/>
<path d="M1 16C1 12.134 4.134 9 8 9C11.866 9 15 12.134 15 16" stroke="currentColor" stroke-linecap="round"/>
</svg>`;
      ...
      <StyledUserSection key={user.userId} className="analytics-view__user-section">
        <StyledUserSectionHeader className="analytics-view__user-section-header">
          ...
          <StyledUserSectionStats className="analytics-view__user-section-stats">
            ...
            <span>{formatTime(user.totalTime)} total</span>
    ...
    <StyledAnalyticsView className="analytics-view">
      ...
      <StyledAnalyticsHeader className="analytics-view__header">
        <div>
          ...
          <StyledAnalyticsSubtitle className="analytics-view__subtitle">
            Análise de uso das abas do sistema por usuário
      ...
      <StyledInfoBox className="analytics-view__info-box">
        <StyledInfoText className="analytics-view__info-text">
          ...
          Apenas usuários não-architect são rastreados. O filtro de período e usuário permite análise detalhada do uso.
        </StyledInfoText>
      </StyledInfoBox>
    </StyledAnalyticsView>
  );
